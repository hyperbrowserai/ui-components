...
export function CodeEditorPane({ document, theme }: CodeEditorPaneProps) {
  if (!document) {
    return <div aria-hidden="true" className="hb-filesystem__empty" />;
  }
  ...
  switch (document.kind) {
    ...
    default:
      return (
        <div className="hb-filesystem__preview" style={codeStyle}>
          <div className="hb-filesystem__binaryShell">
            <div className="hb-filesystem__binaryState">
              ...
              <p className="hb-filesystem__binaryHeadline">PREVIEW UNAVAILABLE</p>
            </div>
          </div>
        </div>
      );
