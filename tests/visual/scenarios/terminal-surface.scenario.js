...
function createMockTerminalConnection() {
  let nextSessionId = 1;
...
function TerminalSurfaceDemo({ TerminalSurface, terminalThemePresets }) {
...
export const terminalSurfaceScenario = {
  ...
  render({ components }) {
    ...
    if (typeof TerminalSurface !== 'function' || !terminalThemePresets) {
      return React.createElement(
        'section',
        {
          style: {
        ...
        React.createElement(
          'p',
          { style: { margin: 0 } },
          'TerminalSurface exports are missing. Build the package after adding terminal exports.'
        )
      );
    }

    return React.createElement(TerminalSurfaceDemo, {
      TerminalSurface,
