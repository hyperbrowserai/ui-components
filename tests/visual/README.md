...
- `filesystem-workspace.scenario.jsx`: Manual check for `FileWorkspace`, including symlink metadata and cyclic symlink traversal behavior (for example `/proc/1/cwd -> /`).
